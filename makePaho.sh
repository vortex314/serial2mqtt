cc -c -g -fPIC -Os -Wall -Ibuild src/Clients.c src/Heap.c  src/MQTTAsync.c \
...
ar -cru build/output/libpaho-mqtt3c.a Clients.o  Heap.o MQTTAsync.o \
...
# cc -static -o build/output/samples/paho_cs_sub src/samples/paho_cs_sub.c build/output/libpaho-mqtt3c.a -I src -lpthread -L build/output
